  ...
  return (
    <SectionWithContainer containerClassName="flex flex-col gap-10">
      <div className="flex flex-col items-center gap-3">
        ...
        {tag && (
          <p className="text-primary text-center font-semibold tracking-[0.2em] text-xs md:text-sm uppercase mt-1">
            {tag}
          </p>
        )}
        <SectionHeading title={title} wrapperClassName="max-w-3xl mx-auto" textCenter />
        <p className="text-secondary text-center lg:text-lg max-w-7xl mx-auto mt-2">
          {description[0]}
        </p>
      </div>
