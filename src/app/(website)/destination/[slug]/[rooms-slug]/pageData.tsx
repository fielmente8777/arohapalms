export const roomData = [
  ...
  "/rooms/Majestic/DSC00193-Edit-scaled-2.jpg",
    ...
    contact: {
      phones: ["+91 7887882414", "+91 7499161229"],
      reservation: "RESERVATION ASSISTANCE AVAILABLE 24 HOURS ON CALL",
      whatsapp: "WHATSAPP ASSISTANCE AVAILABLE FROM 10:00 AM TO 7:00 PM (IST)",
    },

    amenities: {
      title: "AMENITIES",
      subtitle:
        "For the utmost comfort during your stay. For any additional requests our 24/hr concierge will be delighted to assist you.",
    ...
    activity: {
      ...
      activities: ["Yoga", "Wellness", "Nature", "Dining", "Birding", "Beach"],
    },
  },
